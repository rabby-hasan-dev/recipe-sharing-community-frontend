        ...
        <footer className="px-6 bg-slate-100 dark:bg-gray-900 text-gray-500 dark:text-gray-400 py-8 transition-colors duration-300">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-4 text-center">
                    <Link href="/privacy-policy" className="text-sm md:text-base hover:text-gray-700 dark:hover:text-gray-300 transition">
                        Privacy Policy
                    </Link>
                    <Link href="/terms-services" className="text-sm md:text-base hover:text-gray-700 dark:hover:text-gray-300 transition">
                        Terms of Service
                    </Link>
