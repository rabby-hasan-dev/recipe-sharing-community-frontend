...
'use client'
import { Tooltip as RechartsTooltip, CartesianGrid, Line, LineChart, ResponsiveContainer, XAxis, YAxis } from "recharts";
    ...
    return (
        <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data}>
                ...
                />
                <Line type="monotone" dataKey="users" stroke={lineColor} strokeWidth={2} />
            </LineChart>
        </ResponsiveContainer>
    );
};
