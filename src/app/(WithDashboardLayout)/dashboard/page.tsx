  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <StatsCard icon="👤" title="Total Users" value="1,245" />
        <StatsCard icon="👤" title="Premium Users" value="1,245" />
        <StatsCard icon="📅" title="Active Subscriptions" value="325" />
        <StatsCard icon="📦" title="Total Recipes" value="48" />
      </div>
      {/* Graph Section */}
      <div className="mb-6">
