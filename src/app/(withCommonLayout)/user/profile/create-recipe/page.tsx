...
const RecipeForm = () => {
    ...
    const { mutate: handleCreateRecipe, isPending: createRecipePending, isSuccess } = useCreateRecipe();
    ...
    return (
        ...
        <div className="flex flex-col items-center py-10 px-5 sm:px-8 lg:px-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div className="bg-white dark:bg-gray-800 w-full max-w-3xl rounded-lg shadow-lg p-8 sm:p-10 lg:p-12">
                <h2 className="mb-8 text-4xl font-semibold text-gray-800 dark:text-white text-center">
                    Create a New Recipe
                </h2>
