        ...
        <section className="relative bg-cover bg-center  h-[70vh]   bg-[url('/foodBanner.jpg')] bg-no-repeat "   >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6">
                ...
                <div className="space-x-4">
                    <Link href="/register" className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-md transition">Get Started</Link>
                    <Link href="/recipe-feeds" className="bg-white text-orange-500 hover:bg-orange-100 font-semibold py-3 px-6 rounded-md transition">Explore Recipes</Link>
                </div>
            </div>
