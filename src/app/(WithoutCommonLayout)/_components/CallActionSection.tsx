        ...
        <>
            ...
            <section className="bg-gradient-to-r from-orange-600 to-orange-500 py-16 text-center text-white relative overflow-hidden">
                <div className="container mx-auto px-4 z-10 relative">
                    <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Join Our Community and Share Your Culinary Passion!</h2>
                ...
                {/* Decorative Elements */}
                <div className="absolute top-10 right-10 w-32 h-32 bg-white bg-opacity-10 rounded-full transform rotate-45"></div>
                <div className="absolute bottom-10 left-10 w-32 h-32 bg-white bg-opacity-10 rounded-full transform rotate-45"></div>
            </section>
