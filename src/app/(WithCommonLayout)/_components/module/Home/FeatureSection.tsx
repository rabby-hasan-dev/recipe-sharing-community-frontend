        ...
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition duration-200">
            <img
              ...
              className="w-12 mx-auto mb-4"
              src="/icons/social-connect.svg"
            />
            <h3 className="text-xl font-semibold mb-2 text-center text-gray-800 dark:text-white">
              Social Connectivity
            </h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Follow other users, comment on recipes, and build connections with
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition duration-200">
            <img
              alt="Recipe Rating"
              className="w-12 mx-auto mb-4"
              src="/icons/rating-system.svg"
            />
            <h3 className="text-xl font-semibold mb-2 text-center text-gray-800 dark:text-white">
              Recipe Rating System
            </h3>
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Rate and review recipes to highlight the best ones and help users
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition duration-200">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-center">
              Upgrade to a premium membership for exclusive recipes, ad-free
              browsing, and more.
            </p>
          </div>
        </div>
