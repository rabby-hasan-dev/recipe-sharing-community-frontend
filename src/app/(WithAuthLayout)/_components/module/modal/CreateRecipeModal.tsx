...
const CreateRecipeModal = () => {
    ...
    const { mutate: handleCreateRecipe, isPending: createRecipePending, isSuccess, data } = useCreateRecipe();
        ...
        >
            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    >
                        {
                            createRecipePending && !isSuccess ? <><Spinner size="sm" /> <span>  Recipe Uploding ...</span></> : <span>Uplaod Recipe</span>
                        }
                    </Button>
                </form>
            </FormProvider>
